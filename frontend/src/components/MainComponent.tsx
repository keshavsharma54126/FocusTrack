        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4 my-8">
          ...
          <div className="relative flex-grow">
            <Input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm sm:text-base text-gray-900 border border-gray-300 rounded-full bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm"
            />
